...
//         <h1 className="text-5xl lg:text-7xl font-light text-text-primary-title mb-8 px-6 font-playfair ">
//           Five Heritage Rooms
//           <br />
//           Colonial Elegance
//         </h1>
...
//                   {/* Room Title */}
//                   <h2
//                     className={`text-3xl lg:text-4xl xl:text-5xl font-light text-text-primary-title mb-8 font-serif transition-all duration-300 ${
    ...
    <div className="min-h-screen bg-heritage-bg-accent overflow-hidden">
      ...
      >
        ...
        >
          ...
          <p
            className={`text-text-secondary-title/80 text-base sm:text-lg md:text-xl max-w-4xl mx-auto px-4 leading-relaxed transition-all duration-1000 delay-500 ${
              headerVisible
                ? "translate-y-0 opacity-100"
                : "translate-y-10 opacity-0"
            }`}
          ...
          <div
            className={`flex items-center justify-center mt-8 sm:mt-12 md:mt-16 transition-all duration-1000 delay-700 ${
            ...
            return (
              ...
              >
                ...
                <div className="block lg:hidden">
                  <div
                    className={`bg-primary-bg rounded-2xl sm:rounded-3xl shadow-lg overflow-hidden transform transition-all duration-700 hover:shadow-2xl hover:scale-[1.02] border-2 border-text-primary-title ${
                  ...
                  >
                    ...
                    <div className="relative h-64 sm:h-80 md:h-96 overflow-hidden">
                      ...
                      {/* Floating Room Badge */}
                      <div
                        className={`absolute top-4 right-4 w-12 h-12 sm:w-14 sm:h-14 bg-white/10 backdrop-blur-md border border-white/20 rounded-full flex items-center justify-center transition-all duration-500 ${
                    ...
                    <div className="p-6 sm:p-8">
                      <h2
                        className={`text-2xl sm:text-3xl md:text-4xl font-light text-text-primary-title mb-4 sm:mb-6 transition-all duration-300 font-serif ${
                          isHovered
                            ? "text-primary-text-title translate-x-2"
                            : ""
                        }`}
                      >
                        {room.title}
                      ...
                      {/* Mobile Details Grid */}
                      <div
                        className={`grid grid-cols-2 gap-4 p-4 sm:p-6 border border-text-primary-title rounded-xl mb-6 transition-all duration-300 ${
                          isHovered
                            ? "border-primary-text-title bg-primary-text/5"
                            : "bg-primary-bg"
                        }`}
                      >
                        <div className="text-center">
                          <p className="text-xs text-primary-text uppercase tracking-wide">
                            Price
                          </p>
                        ...
                        <div className="text-center">
                          ...
                          <p className="text-sm sm:text-base font-medium text-primary-text-title">
                            {room.size}
                          </p>
                          <p className="text-xs text-primary-text-title">
                            {room.sizeUnit}
                          </p>
                        </div>
                      ...
                      <button
                        className={`w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-button-accent-bg hover:bg-button-accent-bg/90 text-heritage-bg-accent rounded-full text-sm sm:text-base font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-lg ${
                ...
                <div className="hidden lg:block">
                  <div
                    className={`grid grid-cols-2 gap-0 min-h-[600px] xl:min-h-[700px] bg-primary-bg rounded-3xl overflow-hidden shadow-lg transition-all duration-700 hover:shadow-2xl hover:scale-[1.01] border-2 border-text-primary-title ${
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <div
                        className={`absolute inset-0 bg-gradient-to-r from-black/30 to-transparent transition-opacity duration-500 ${
                          isHovered ? "opacity-20" : "opacity-40"
                        }`}
                      />
                      ...
                      {/* Room Badge */}
                      <div
                        className={`absolute top-6 left-6 w-14 h-14 bg-white/10 backdrop-blur-md border border-white/20 rounded-full flex items-center justify-center transition-all duration-500 ${
                    ...
                    {/* Content Section */}
                    <div
                      className={`p-12 xl:p-16 flex flex-col justify-center transition-all duration-500 ${
                    ...
                    >
                      ...
                      <h2
                        className={`text-4xl xl:text-5xl 2xl:text-6xl font-light text-text-primary-title mb-8 xl:mb-10 transition-all duration-300 leading-tight font-serif ${
                      ...
                      {/* Desktop Details */}
                      <div
                        className={`border border-text-primary-title p-8 mb-8 xl:mb-10 transition-all duration-300 ${
                          isHovered
                            ? "border-primary-text-title bg-primary-text/5"
                            : "bg-primary-bg"
                        }`}
                      ...
                      <p
                        className={`text-stone-600 text-lg xl:text-xl leading-relaxed mb-8 xl:mb-10 transition-opacity duration-300 ${
                          isHovered ? "opacity-100" : "opacity-90"
                        }`}
                      >
                        {room.description}
                      ...
                      <button
                        className={`self-start px-8 py-4 bg-amber-700 hover:bg-amber-800 text-white rounded-full text-sm xl:text-base font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-lg ${
      ...
      <div className="relative py-12 sm:py-16 md:py-20 bg-heritage-bg-accent">
        <div className="flex items-center justify-center">
